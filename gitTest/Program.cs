...
namespace gitTest
{
    ...
    class Program
    {
       ...
       static IntPtr hWindow = IntPtr.Zero;
            ...
            else
            {
                    ...
                    INPUT[] pInputs = new INPUT[]
               {
                  ...
                  new INPUT()
                  {
                    ...
                    INPUT[] ar = stringToInput("XEROX PHASER 7100DN FARBDRUCKER A3 /GARANTIE O.CASH-BACK-PRO").ToArray();
                    SendInput((uint)ar.Length, ar, INPUT.Size);


                    //19LS350S ввод наименования артикля
                    ...
                    Thread.Sleep(2000);
                    //прийдется ждать так как до подтверждения артикля нужно ждать прогружение всех подходящих по зухбегрифу вариантов.....по сути должен быть один
                    INPUT[] enterArtikel = new INPUT[]
                    {
                        new INPUT()
                          {
                              type = InputType.KEYBOARD,
        ...
        static List<INPUT> stringToInput(string str)
        {
